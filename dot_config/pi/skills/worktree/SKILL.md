...
- `/skill:worktree opencode+feature-auth` - Creates/switches to worktree for branch `opencode+feature-auth`
- `/skill:worktree reviewer+fix-bug-123` - Creates/switches to worktree for branch `reviewer+fix-bug-123`
